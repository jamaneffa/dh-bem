...
const productsController = {
    ...
    search: async (req,res) => {
        try {
            const productsByQuery = await productServices.getProductsByQuery(req.query.search)

            return res.render('./products/listProducts', { products: productsByQuery });
        } catch (error) { 
    ...
    list: async (req, res) => {
        try {
            ...
            if (req.params.category) {
                const productsByCategory = await productServices.getProductsByCategory(req.params.category)
                return res.render('./products/listProducts', { products: productsByCategory});
            } else {
                const products = await productServices.getAllProducts()
                return res.render('./products/listProducts', { products: products});
            }
        } catch (error) {
            console.log(error.message);
        }
    ...
    detail: async (req, res) => {
        try {
            ...
            let categoryProducts = await productServices.getProductsByCategory(product.category_id)
